  ...
  return (
    <main className="flex-1">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto flex max-w-5xl flex-col items-start px-6 py-24 sm:py-32">
          ...
          <h1
            className="animate-fade-up glow-text mt-6 max-w-3xl text-4xl font-black text-navy sm:text-6xl"
