      ...
      <div className="mt-8">
        {!curso || !turma ? (
          <div className="rounded-2xl border border-border bg-white p-6 text-navy">
            ...
            <Link
              href="/contato"
              className="mt-4 inline-block rounded-full bg-coral px-5 py-2 text-sm font-bold text-white hover:bg-peach"
            >
              Avise-me
            </Link>
          </div>
          ...
          <>
            <p className="mb-6 rounded-xl border border-border bg-white px-4 py-3 text-sm text-slate">
